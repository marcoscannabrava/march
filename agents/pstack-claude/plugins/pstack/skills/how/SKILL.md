...
**Platform note.** On Codex or another non-Claude runtime, the Claude tool names below are Claude defaults. Resolve them via [`codex-tools.md`](../poteto-mode/references/codex-tools.md).

Two modes:

1. **Explain** (default). Explore the codebase and produce a clear explanation
2. **Critique.** Explain first, then spawn several critics to independently identify architectural issues
...
After the explanation is complete, spawn four architectural critics, all in a single message.
